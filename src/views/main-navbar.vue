  ...
  <nav class="site-navbar" :class="'site-navbar--' + navbarLayoutType">
    <div class="site-navbar__header">
      <h1 class="site-navbar__brand" @click="$router.push({ name: 'home' })">
        <a class="site-navbar__brand-lg" href="javascript:;">手术管理系统</a>
        <a class="site-navbar__brand-mini" href="javascript:;">手术</a>
      </h1>
    </div>
    <div class="site-navbar__body clearfix">
      ...
      <el-menu
        ...
        mode="horizontal">
        <el-menu-item index="1" v-if="isAuth('wx:wxaccount:list')">
          <template slot="title">
            <wx-account-selector></wx-account-selector>
          </template>
        </el-menu-item>
        <el-menu-item index="3" @click="showTheme()">
          <template slot="title">
...
export default {
  ...
  components: {
    UpdatePassword, WxAccountSelector, Theme
  },
  computed: {
    navbarLayoutType: {
      get () {
