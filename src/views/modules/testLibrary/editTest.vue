<template>
  <div class="addStudent">
    <el-dialog title="考题库解绑考题" :lock-scroll="false" :close-on-click-modal="false" :fullscreen="true"
        ...
        <div class="top">
          ...
          <div class="base-info">
            <el-form class="search-form" :inline="true" :model="searchForm" @keyup.enter.native="getTestList(1)">
              <el-form-item>
                <el-input v-model="searchForm.name" placeholder="考题名称" clearable style="width: 160px"></el-input>
              </el-form-item>
              <el-form-item>
              ...
              <el-form-item>
                <div class="flex-start" style="align-items: flex-start">
                  <el-button :disabled='selectDataList.length == 0' type="danger" @click="delItem('branch')" icon="el-icon-delete-solid">解绑</el-button>
                </div>
              </el-form-item>
            </el-form>
          </div>
          ...
          <el-table :data="dataList" :height="tableHeight" border size="mini" style="width: 100%;" height='30%'
            ...
            <el-table-column fixed="right" align="center" label="操作" width="80">
              <template slot-scope="scope">
                <el-button title="解绑" icon="icon iconfont icon-shanchu" type="danger" circle size="mini"
...
<script>
import { examinationList, deleteExamination } from '@/api/testLibrary.js'
export default{
  props: {
    editVisable: {
      type: Boolean,
    ...
    delItem (val) {
      ...
      this.$msgbox({
        ...
        message: h('p', {style: 'width: 400px;'}, [
          ...
          h('span', { style: 'color: #666' }, '请确认是否解绑?')
        ]),
        ...
        beforeClose: (action, instance, done) => {
          if (action === 'confirm') {
            ...
            console.log(params)
            deleteExamination(params).then(res => {
              done()
